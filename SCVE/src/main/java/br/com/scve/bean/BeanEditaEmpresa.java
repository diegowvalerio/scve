...
@Named
@ViewScoped
public class BeanEditaEmpresa implements Serializable{
	...
	public void carregar(){
		...
		if (this.empresa.getTipojf().equals("J")) {
			isRederiza = true;
			isRederiza2 = false;
			this.pjuridica = servico.consultarPjuridica(this.empresa.getIdpessoa());
		}
		if (this.empresa.getTipojf().equals("F")) {
			isRederiza = false;
			isRederiza2 = true;
			this.pfisica = servico.consultarPfisica(this.empresa.getIdpessoa());
		}
	}
